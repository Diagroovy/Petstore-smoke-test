...
public class BaseEndPoints {
    ...
    protected final String BASE_URL = "https://petstore.swagger.io/v2/swagger.json";
    ...
    protected JSONObject createJSONPayload(Object test) {
        return new JSONObject(test);
    }

    
    public Response sendRequest(RequestSpecification request, int requestType, String url, Object test) {
        Response response = null;

        
        // Add the Json to the body of the request
        if (test != null) {
            String payload = createJSONPayload(test).toString();
